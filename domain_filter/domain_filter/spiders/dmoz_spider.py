...
query_file = open('/Users/sunjian/Desktop/hc项目/domain_drqz/domain_filter/domain.txt','w')
...
class DmozSpider(scrapy.Spider):
    name = "domain"
    start_urls = []
    for word in open('/Users/sunjian/Desktop/hc项目/domain_drqz/domain_filter/domain.txt'):
        word = word.strip()
